...
class Product extends Model
{
    ...
    public function product_skin_types()
    {
        return $this->belongsToMany(SkinType::class, 'product_skin_types', 'product_id', 'skin_type_id');
    }

    public function product_concenrs()
    {
        return $this->belongsToMany(Concern::class, 'product_concerns', 'product_id', 'concern_id');
    }
