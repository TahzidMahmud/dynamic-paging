...
class AttributeController extends Controller
{
    ...
    public function show($id,Request $request)
    {
        ...
        $attribute_type=($attribute->name=='Color') || ($attribute->name=='color') ?'color':'not_color';

        $attribute_values = AttributeValue::where('attribute_id',$id)->orderBy('created_at', 'desc')->paginate(10);
        return view("backend.product.attribute.attribute_values.index", compact('attribute','attribute_values','attribute_type'));
    }
