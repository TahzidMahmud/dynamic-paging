...
class ConversationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product = Product::findOrFail($form_data['product_id']);

        // dd($product->user);
        $conversation = new Conversation;
        $conversation->sender_id = Auth::user()->id;
        $conversation->receiver_id = $product->shop->user->id;
        ...
        if($conversation->save()) {
            ...
            $message->message = $form_data['query'];
        ...
        return response()->json([
            'success' => true,
            'data' => null,
            'message' => translate('Your Query has been received.')
        ]);
    }
