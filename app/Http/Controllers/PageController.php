...
class PageController extends Controller
{
   ...
   public function edit(Request $request, $id)
   {
		...
		if($page != null){
			...
			elseif ($page_name == 'sister-concern') {
				return view('backend.website_settings.pages.sister_concern_page_edit', compact('page','lang'));
			}
			elseif ($page_name == 'key-management') {
				return view('backend.website_settings.pages.key_management_page_edit', compact('page','lang'));
			}
			elseif ($page_name == 'message-from-md') {
				return view('backend.website_settings.pages.message_from_md_page_edit', compact('page','lang'));
			}
			elseif ($page_name == 'about-ejdl') {
				return view('backend.website_settings.pages.about_ejdl_page_edit', compact('page','lang'));
			}
			else{
