...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('report_action_logs.index') }}" method="GET">
                    ...
                    <label class="col-md-2 col-form-label">{{translate('Sort by report type')}} :</label>
                    <div class="form-group row ">
                        <div class="col-md-3">
                            <select class="from-control aiz-selectpicker" name="action_log" class="text-center" style="width: 2rem!important;">
                                <option value="" class="text-center">--Select Report Type--</option>
                                @foreach ($action_logs as $elem)
                                <option value="{{ $elem }}" @if($elem == $action_log) selected @endif>{{ $elem}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
