                    ...
                    <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Banner') }}
                                <small>({{ translate('100x100') }})</small></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Big Banner') }}
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="big_banner" class="selected-files"
                                        value="{{ $category->big_banner }}">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
