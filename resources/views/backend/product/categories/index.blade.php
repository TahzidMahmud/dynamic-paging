            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg">{{ translate('Big Banner') }}</th>
                ...
                <tbody>
                    @foreach ($categories as $key => $category)
                        <tr>
                            ...
                            <td>
                                <img src="{{ uploaded_asset($category->big_banner) }}" alt="{{ translate('Big Banner') }}"
                                    class="h-50px"
                                    onerror="this.onerror=null;this.src='{{ static_asset('/assets/img/placeholder.jpg') }}';">
                            </td>
                            <td>
                                <img src="{{ uploaded_asset($category->image) }}" alt="{{ translate('Image') }}"
                                    class="h-50px"
                                    onerror="this.onerror=null;this.src='{{ static_asset('/assets/img/placeholder.jpg') }}';">
                            </td>
                            <td>
