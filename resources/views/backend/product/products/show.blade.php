        ...
        <div class="col-lg-auto w-lg-320px">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        <span class="mr-2 ml-0">{{ translate('Skin Types') }}:</span>
                        <span class="text-right">

                            @foreach ($product->product_skin_types as $skin_type)
                                <span
                                    class="badge badge-inline badge-md bg-soft-dark mb-1">{{ $skin_type->name }}</span>
                            @endforeach
                        </span>
                    </div>
                    <div class="mb-3 d-flex justify-content-between">
                        <span class="mr-2 ml-0">{{ translate('Concerns') }}:</span>
                        <span class="text-right">
                            @foreach ($product->product_concenrs as $concern)
                                <span
                                    class="badge badge-inline badge-md bg-soft-dark mb-1">{{ $concern->name }}</span>
                            @endforeach
                        </span>
                    </div>
                    <div class="mb-3 d-flex justify-content-between">
