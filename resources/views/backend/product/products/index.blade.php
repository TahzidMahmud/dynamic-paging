            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md">{{ translate('Stocks') }}</th>
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach ($product->variations as $variation)
                                    <span>SKU: {{ $variation->sku ??'Not Found' }}</span><br>
                                    <span>Stock: {{ $product->stock }}@if(!($product->low_stock_quantity<$product->stock)) <span class="badge badge-inline badge-danger">Low</span>@endif</span>
                                @endforeach
                            </td>
                            <td class="text-right">
                                @can('view_products')
                                ...
                                @endcan
                                @can('delete_products')
                                    <a href="{{ route('product.destroy', $product->id) }}" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
