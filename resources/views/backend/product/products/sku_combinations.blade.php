        ...
        <tbody>
            @foreach ($combinations as $key => $combination)
                ...
                <tr class="variant">
                    ...
                    <td>
                        <input type="number" step="0.01" name="variations[{{ $key }}][purchase_price]" value="0" min="0"
                            class="form-control" required>
                    </td>
                    <td>
                        <input type="number" lang="en" min="0" value="0" placeholder="{{ translate('Stock') }}" name="variations[{{ $key }}][stock]" class="form-control"
                                    required>
                    </td>
                    <td>
