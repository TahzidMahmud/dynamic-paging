        ...
        <div class="card-body">
            <form action="{{ route('offers.store') }}" method="POST">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-9">
                        <span class="p-1 text-center rounded bg-info text-white"><i class="las la-info-circle"></i> Please enter product name or SKU to search.</span>
                        <select name="products[]" id="products" class="form-control with-ajax" multiple required data-placeholder="{{ translate('Choose Products') }}" data-live-search="true" data-selected-text-format="count" data-toggle="products-search">
                        </select>
                    </div>
                </div>
