                ...
                <table class="text-right sm-padding" style="border-collapse:collapse">
                    <tbody>
                        ...
                        @if ($order->combined_order->advanced_payment!=null)
                            <tr class="">
                                <td class="text-left" style="border-bottom:1px solid #DEDEDE">
                                    {{ translate('Advanced Payment') }}</td>
                                <td class="bold" style="border-bottom:1px solid #DEDEDE">
                                    {{ $order->combined_order->advanced_payment }} (Paid)</td>
                            </tr>
                        @endif
                        <tr>
                            <td class="text-left bold">{{ translate('Grand Total') }}</td>
                            <td class="bold">{{ $order->combined_order->advanced_payment!=null?format_price($order->grand_total - $order->combined_order->advanced_payment):format_price($order->grand_total) }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
