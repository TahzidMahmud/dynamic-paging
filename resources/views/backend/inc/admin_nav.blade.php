    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        <div class="d-none d-md-flex justify-content-around align-items-center align-items-stretch">
            <div class="aiz-topbar-item align-items-center ">
                <div class="d-flex">
                 <input type="text" name="search" class="form-control input-outline nav-src " placeholder="Search">
                    <img style="margin-left:-2rem;" src="{{ static_asset('assets/img/search.svg') }}" alt="">
                </div>
            </div>
            <div class="aiz-topbar-item align-items-center dropdown ml-4 mr-0 ">
                <a class="btn btn-outline-secondary border-gray-600 d-flex align-items-center px-3" href="{{ route('home')}}" target="_blank">
