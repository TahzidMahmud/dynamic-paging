            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Event') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        @can('show_reviews')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('event.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['event.create', 'event.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('All Events') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('event.video') }}" class="aiz-side-nav-link {{ areActiveRoutes(['event.video'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Videos') }}</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @can('show_products')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product.create') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['product.create']) }}">
                        ...
                        @can('show_products')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('showcase-product.create') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['showcase-product.create']) }}">
                                    <span class="aiz-side-nav-text">
                        ...
                        @can('show_products')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('showcase-product.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['showcase-product.index', 'showcase-product.create', 'showcase-product.edit']) }}">
                                    <span class="aiz-side-nav-text">
                                        {{ addon_is_activated('multi_vendor') ? translate('Inhouse Showcase Products') : translate('Showcase Products') }}
                                    </span>
                                </a>
                            </li>
                        @endcan
                                    ...
                                    @can('manage_pos')
                                        ...
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('orders.pos') }}"
                                                class="aiz-side-nav-link {{ areActiveRoutes(['orders.pos']) }}">
                ...
                @can('manage_pos')
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('pos.index') }}" class="aiz-side-nav-link">
                ...
                @can('show_customers')
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('customers.query') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['customers.query']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Customers Query') }}</span>
                                    </a>
                                </li>
                        </ul>
                    </li>
                ...
                <!-- Reports -->
                    ...
                    <li class="aiz-side-nav-item">
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('stock_report.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['stock_report.index', 'stock_report.index']) }}">
                                            <span class="aiz-side-nav-text">
                                                Products Stock
                                            </span>
                                        </a>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sale_report.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['sale_report.index', 'sale_report.index']) }}">
                                        <span class="aiz-side-nav-text">
                                            Sale Stats
                                        </span>
                                    </a>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('best_selling_product_report.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['best_selling_product_report.index', 'best_selling_product_report.index']) }}">
                                        <span class="aiz-side-nav-text">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('offer_sales.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['offer_sales.index', 'offer_sales.show']) }}">
                                        <span class="aiz-side-nav-text">
                                            Offer Wise Sales
                                        </span>
                                    </a>
                ...
                @can('view_activity_logs')
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('productlog.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['productlog.index', 'productlog.index']) }}">
                                        <span class="aiz-side-nav-text">
                                            Product Action Log
                                        </span>
                                    </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('order_action_logs.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['order_action_logs.index', 'order_action_logs.index']) }}">
                                        <span class="aiz-side-nav-text">
                                            Order Action Log
                                        </span>
                                    </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('order_process_logs.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['order_process_logs.index', 'order_process_logs.index']) }}">
                                        <span class="aiz-side-nav-text">
                                            Order Process Log
                                        </span>
                                    </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customer_data_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['customer_data_logs.index', 'customer_data_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        Customer Data Action Log
                                    </span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('user_action_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['user_action_logs.index', 'user_action_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        User Action Log
                                    </span>
                                </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('role_action_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['role_action_logs.index', 'role_action_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        Role Action Log
                                    </span>
                                </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('staff_action_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['staff_action_logs.index', 'staff_action_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        Staff Action Log
                                    </span>
                                </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('coupon_action_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['coupon_action_logs.index', 'coupon_action_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        Coupon Action Log
                                    </span>
                                </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('offer_action_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['offer_action_logs.index', 'offer_action_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        Offer Action Log
                                    </span>
                                </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('report_action_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['report_action_logs.index', 'report_action_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        Report Action Log
                                    </span>
                                </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('home_page_edit_logs.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['home_page_edit_logs.index', 'home_page_edit_logs.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        Home Page Action Log
                                    </span>
                                </a>
                            </li>
                        </ul>
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('cities.index') }}"
                                            ...
                                            <span class="aiz-side-nav-text">{{ translate('Upazila') }}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
